...
if (isset($_POST['email'])) {
	...
	$emails_amount = $result->fetchColumn();
	if ($emails_amount > 0) {
		$is_good = false;
	...
	if ($is_good == true) {
		$statement = $db->prepare("INSERT INTO users VALUES (NULL, '$username', '$password_hash','$email')");
					...
					<div class="row text-center justify-content-center border rounded-3 bg-success p-4 text-dark bg-opacity-10">
						<div class="col-12 text-center m-auto">
							...
							<div class="input-group mb-1 mx-auto">
								...
								<input type="password" name="check_password" class="form-control" id="check_password" aria-describedby="passwordHelp" placeholder="Confirm Password">
							</div>
