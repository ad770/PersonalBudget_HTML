...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark justify-content-start p-3">
        <div class="container-fluid">
            <a class="navbar-brand" href="main.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                    fill="currentColor" class="bi bi-bank2" viewBox="0 0 1em 1em">
                    <path
                        d="M8.277.084a.5.5 0 0 0-.554 0l-7.5 5A.5.5 0 0 0 .5 6h1.875v7H1.5a.5.5 0 0 0 0 1h13a.5.5 0 1 0 0-1h-.875V6H15.5a.5.5 0 0 0 .277-.916l-7.5-5zM12.375 6v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zM8 4a1 1 0 1 1 0-2 1 1 0 0 1 0 2zM.5 15a.5.5 0 0 0 0 1h15a.5.5 0 1 0 0-1H.5z" />
                </svg> System zarządzania budżetem osobisym</a>
            <div class="navbar-nav">
                <a class="nav-link" href="settings.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        fill="currentColor" class="bi bi-gear" viewBox="0 0 1em 1em">
                        <path
                ...
                <a class="nav-link" href="logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        fill="currentColor" class="bi bi-power" viewBox="0 0 1em 1em">
            ...
            <div class="row">
                <div class="col-10 col-sm-10 col-md-8 col-lg-7 mx-auto">
                    <ul class="nav nav-tabs nav-justified text-center">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="main.php"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    class="bi bi-house" viewBox="0 0 1em 1em">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="income.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 1em 1em">
                                    <path
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="expense.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" fill="currentColor" class="bi bi-cart-dash" viewBox="0 0 1em 1em">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="balance.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" fill="currentColor" class="bi bi-shuffle" viewBox="0 0 1em 1em">
                                    <path fill-rule="evenodd"
        ...
        <div class="budget_panel">
            <form method="post">
				<?php
					...
					{
						echo "<div class='row col-4 mx-auto my-2 rounded-pill alert alert-success text-center col-3 justify-content-center center' role='alert'> Wydatek został poprawnie dodany!</div>";
						unset($_SESSION['successful_submit']);
					}
				?>
				<div class="row col-8 col-sm-6 col-md-5 col-lg-4 mx-auto my-2">
					<label for="expense"></label>
					<input type="number" step="0.01" class="rounded-pill" name="expense" id="expense" placeholder="100,00 zł" required>
				</div>
				<div class="row col-8 col-sm-6 col-md-5 col-lg-4 mx-auto my-2">
				...
				<div class="row col-8 col-sm-6 col-md-5 col-lg-4 mx-auto my-2">
						...
						<textarea name="expense_comment" cols="20" rows="5" class="rounded" id="expense_comment"
